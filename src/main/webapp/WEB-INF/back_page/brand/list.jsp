...
<div class="body-box">
	...
	<form action="#" id="jvForm">
		<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
			...
			<tbody class="pn-ltbody">
				<c:forEach items="${brandListWithPage.pageData}" var="entry">
					...
					<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
						...
						<td align="center">
							...
							| <a class="pn-opt" onclick=" if(confirm('您确定删除吗?') == false) {return false} else {window.location.href='/brand/delete.do?id=${entry.id }&name=${name}&isDisplay=${isDisplay}'}" href="javascript:void(0)">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
	...
	<div class="page pb15">
		...
		<span class="r inb_a page_b">
			...
			<c:forEach items="${brandListWithPage.pageView }" var="page">
				${page}
			</c:forEach>
		</span>
	</div>
	...
	<div style="margin-top:20px;">
		<input class="del-button" type="button" value="删除" onclick="optDelete('${name}','${isDisplay}')"/>
	</div>
</div>
</body>
</html>