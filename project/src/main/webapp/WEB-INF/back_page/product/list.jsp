...
<div class="body-box">
	...
	<form method="post" id="jvForm">
		<table cellspacing="1" cellpadding="0" width="100%" border="0" class="pn-ltable">
			...
			<c:forEach items="${pagination.pageData }" var="entry">
				<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
					...
					<td align="center">
						<a href="#" onclick="window.location.href='/product/detail.shtml?id=${entry.id}'"class="pn-opt">查看</a> | <a href="#" class="pn-opt">修改</a> | <a href="#" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt">删除</a> | <a href="/sku/list.do" class="pn-opt">库存</a>
					</td>
				</tr>
			</c:forEach>
		...
		<div style="margin-top:15px;">
			...
			<input class="add" type="button" value="上架" onclick="isShow('${pagination.currentPage}','${name }','${brandId }','${isShow }');"/>
